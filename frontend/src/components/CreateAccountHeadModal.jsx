    ...
    <div style={{ backgroundColor: '#ffffff', padding: '16px', borderRadius: '12px', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '16px', flexWrap: 'wrap', gap: '10px' }}>
        <div>
          ...
          <span style={{ fontSize: '11px', color: '#64748b' }}>Active Context: {firm?.legal_name || 'Neelkanth Int Udyog'}</span>
        </div>

        <button
          onClick={handleOpenCreateModal}
          style={{ backgroundColor: '#2563eb', color: '#ffffff', border: 'none', padding: '10px 16px', borderRadius: '8px', fontWeight: 'bold', fontSize: '12px', cursor: 'pointer', boxShadow: '0 2px 6px rgba(37,99,235,0.3)' }}
        >
      ...
      <div style={{ marginBottom: '16px' }}>
        <input
          ...
          style={{ width: '100%', padding: '9px 12px', borderRadius: '6px', border: '1px solid #cbd5e1', fontSize: '12px', boxSizing: 'border-box' }}
        />
      </div>

      {/* Responsive Horizontal Scroll Directory Table */}
      <div style={{ overflowX: 'auto', border: '1px solid #cbd5e1', borderRadius: '8px' }}>
        <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '12px', minWidth: '550px' }}>
          <thead>
            <tr style={{ backgroundColor: '#0f172a', color: '#ffffff' }}>
              <th style={{ padding: '10px', textAlign: 'left', minWidth: '140px' }}>Account / Party Name</th>
              <th style={{ padding: '10px', textAlign: 'left', minWidth: '110px' }}>Sub-Group</th>
              <th style={{ padding: '10px', textAlign: 'left', minWidth: '90px' }}>Primary Type</th>
              <th style={{ padding: '10px', textAlign: 'right', minWidth: '110px' }}>Balance (₹)</th>
              <th style={{ padding: '10px', textAlign: 'center', minWidth: '80px' }}>Action</th>
            </tr>
          </thead>
          <tbody>
            {filteredAccounts.length === 0 ? (
              <tr>
                <td colSpan="5" style={{ textAlign: 'center', padding: '20px', color: '#94a3b8' }}>
                  No account heads found. Click above to create one.
                </td>
              </tr>
            ) : (
                ...
                <tr key={acc.id || idx} style={{ borderBottom: '1px solid #e2e8f0', backgroundColor: idx % 2 === 0 ? '#ffffff' : '#f8fafc' }}>
                  ...
                  <td style={{ padding: '10px', textAlign: 'center' }}>
                    <button
                      ...
                      style={{ backgroundColor: '#1e293b', color: '#ffffff', border: 'none', padding: '6px 12px', borderRadius: '4px', fontSize: '11px', fontWeight: 'bold', cursor: 'pointer' }}
                    >
                      ✏️ Edit
                    </button>
                  </td>
      ...
      {/* High Priority Pop-up Modal Window */}
      {isModalOpen && (
        <div style={{ position: 'fixed', top: 0, left: 0, right: 0, bottom: 0, backgroundColor: 'rgba(15, 23, 42, 0.75)', display: 'flex', alignItems: 'center', justifyContent: 'center', zIndex: 9999, padding: '16px' }}>
          <div style={{ backgroundColor: '#ffffff', width: '100%', maxWidth: '500px', borderRadius: '12px', padding: '20px', boxShadow: '0 10px 25px rgba(0,0,0,0.3)', maxHeight: '90vh', overflowY: 'auto' }}>
