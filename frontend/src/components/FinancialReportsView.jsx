...
import { downloadFinancialStatementsPDF } from '../utils/pdfDownloadEngine.js';
  ...
  return (
    <div>
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px', flexWrap: 'wrap', gap: '8px' }}>
        <div>
          <h3 style={{ margin: 0, color: '#0f172a', fontSize: '18px' }}>📊 Financial Statements & Reports</h3>
          <span style={{ fontSize: '11px', color: '#64748b' }}>Firm: {firmName}</span>
        </div>
        <button 
          onClick={() => downloadFinancialStatementsPDF(firmName, reports)} 
          style={{ backgroundColor: '#dc2626', color: '#ffffff', border: 'none', padding: '8px 16px', borderRadius: '6px', fontSize: '12px', fontWeight: 'bold', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '6px' }}
        >
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '16px' }}>
        ...
        <div style={{ backgroundColor: '#ffffff', padding: '16px', borderRadius: '12px', border: '1px solid #cbd5e1', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
          <h3 style={{ margin: '0 0 12px 0', color: '#0f172a', fontSize: '16px', borderBottom: '2px solid #3b82f6', paddingBottom: '6px' }}>
        ...
        {/* Balance Sheet */}
        <div style={{ backgroundColor: '#ffffff', padding: '16px', borderRadius: '12px', border: '1px solid #cbd5e1', boxShadow: '0 2px 8px rgba(0,0,0,0.06)' }}>
          <h3 style={{ margin: '0 0 12px 0', color: '#0f172a', fontSize: '16px', borderBottom: '2px solid #10b981', paddingBottom: '6px' }}>
