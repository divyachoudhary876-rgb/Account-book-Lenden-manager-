...
export const getAccountHeads = (firmId) => {
  ...
  // Clean initialization without dummy hardcoded accounts
...
// EXPLICIT NAMED EXPORT: Fixes Vite Build Rollup Error in AccountStatementView.jsx
export const downloadCSVStatement = (firmName, accountName, transactions) => {
  if (!transactions || transactions.length === 0) {
    alert("⚠️ Selected account aur date range me export karne ke liye koi transactions nahi hain.");
    return;
  }
